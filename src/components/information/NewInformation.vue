  ...
  <div class="add_information">
    ...
    <div class="bottom_list">
      ...
      <div class="table_list">
        <el-form label-width="200px" size="small" :inline-message="true" style="margin-top: 20px;" ref="cookbook" :model="addInfo"
                 :rules="rulesAddInfo">
          ...
          <el-form-item label="消息内容：" prop="content">
            <el-input type="textarea" size="small" style="width:700px;" rows="6" maxlength="250"
                      v-model="addInfo.content"></el-input>
          </el-form-item>
