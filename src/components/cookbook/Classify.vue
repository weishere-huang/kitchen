	...
	<div class="cookbook_classify">
			...
			<el-dialog title="添加分类" :visible.sync="dialogAdd" width="500px" :close-on-click-modal="false">
				<el-form label-width="90px" style="margin-top:16px;">
					...
					<el-form-item label="分类名称：">
						<el-input size="small" style="width:99%;"></el-input>
					</el-form-item>
				...
				<span slot="footer" class="dialog-footer">
					...
					<el-button type="primary" @click="dialogAdd = false" size="small">确 定</el-button>
				</span>
			</el-dialog>
		</div>
		<div class="bottom_list">
			...
			<div style="padding:10px;overflow:hidden">
				...
				<el-tree :data="classifyData" node-key="id" default-expand-all :expand-on-click-node="false">
		...
		<el-dialog title="修改分类" :visible.sync="dialogEdit" width="500px" :close-on-click-modal="false">
			...
			<span slot="footer" class="dialog-footer">
				...
				<el-button type="primary" @click="dialogEdit = false" size="small">确 定</el-button>
			</span>
		</el-dialog>
	</div>
</template>
